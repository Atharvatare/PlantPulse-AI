...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-industrial-900 transition-colors duration-300 flex page-enter">
      {/* Visual Left Panel */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-50/50 via-stone-100/40 to-emerald-50/50 dark:from-secondary-950/20 dark:via-industrial-950 dark:to-primary-950/20 border-r border-stone-200 dark:border-industrial-800/30 relative overflow-hidden items-center justify-center">
        {/* Glow circles */}
        ...
        <div className="relative text-center px-12 max-w-lg float-animation">
          ...
          <h2 className="text-3xl font-extrabold text-stone-900 dark:text-white tracking-tight mb-4">Join PlantPulse AI</h2>
          ...
          <div className="mt-10 p-5 rounded-2xl bg-white dark:bg-industrial-800 border border-stone-200 dark:border-industrial-700/30 shadow-md text-left max-w-sm mx-auto">
            <div className="flex justify-between items-center mb-3">
              <span className="text-[10px] font-bold text-stone-400 uppercase tracking-wide">Predictive Engine</span>
              <span className="text-xs px-2 py-0.5 rounded-full bg-primary-100/80 dark:bg-primary-500/10 text-primary-750 dark:text-primary-400 font-bold border border-primary-200 dark:border-primary-500/20">Active</span>
            </div>
            <div className="text-lg font-bold text-stone-850 dark:text-white">AI health prediction ready</div>
            <div className="text-xs text-stone-450 dark:text-industrial-500 mt-1 font-semibold">Accuracy scored at 94.8%</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-10">
        <div className="w-full max-w-md bg-white dark:bg-industrial-800 sm:border border-stone-200 dark:border-industrial-700/50 rounded-2xl p-6 sm:p-10 sm:shadow-xl sm:shadow-stone-100/40 dark:sm:shadow-none">
          ...
          <h1 className="text-2xl font-extrabold text-stone-900 dark:text-white tracking-tight mb-1">Create Account</h1>
          <p className="text-sm text-stone-500 dark:text-industrial-400 mb-6 font-semibold">Register for your PlantPulse AI access</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <FiUser className="absolute left-3.5 top-1/2 -translate-y-1/2 text-stone-455 dark:text-industrial-500" size={16} />
                <input 
                  type="text" 
                  value={form.name} 
            ...
            <div>
              ...
              <div className="relative">
                <FiMail className="absolute left-3.5 top-1/2 -translate-y-1/2 text-stone-455 dark:text-industrial-500" size={16} />
                <input 
                  type="email" 
                  value={form.email} 
            ...
            <div>
              <label className="block text-xs font-bold text-stone-700 dark:text-industrial-300 uppercase tracking-wider mb-1.5">Role</label>
              <select 
                value={form.role} 
                onChange={(e) => setForm({ ...form, role: e.target.value })} 
                className="w-full bg-stone-50 dark:bg-industrial-900 border border-stone-200 dark:border-industrial-700/50 text-stone-900 dark:text-white text-sm rounded-xl px-4 py-3 focus:outline-none focus:border-primary-500/50 focus:ring-4 focus:ring-primary-500/10 transition-all font-bold"
              >
                {USER_ROLES.map((r) => <option key={r} value={r} className="bg-white dark:bg-industrial-800 text-stone-850 dark:text-white">{r}</option>)}
              </select>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <FiLock className="absolute left-3.5 top-1/2 -translate-y-1/2 text-stone-455 dark:text-industrial-500" size={16} />
                <input 
                ...
                <button 
                  ...
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-stone-455 hover:text-stone-700 dark:text-industrial-400 dark:hover:text-white transition-colors"
                >
            ...
            <div>
              <label className="block text-xs font-bold text-stone-700 dark:text-industrial-300 uppercase tracking-wider mb-1.5">Confirm Password</label>
              <div className="relative">
                <FiLock className="absolute left-3.5 top-1/2 -translate-y-1/2 text-stone-455 dark:text-industrial-500" size={16} />
                <input 
                  type={showPw ? 'text' : 'password'} 
          ...
          <p className="text-center text-sm text-stone-500 dark:text-industrial-400 mt-8 font-bold">
            Already have an account? <Link to="/login" className="text-primary-700 dark:text-primary-400 hover:underline font-extrabold">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
